  ...
  return (
    <Container>
      <Row style={{ padding: "10px" }}>
          <Row className="border-bottom mb-4"><h2>Summer Concert Series</h2></Row>
        ...
        <Col xs={12} lg={5} style={{ height: "400px", padding: "10px" }} className="mb-3">
          <Image style={{ height: "400px" , objectFit: "cover" }} src="../images/patio.jpg" roundedCircle fluid />
        </Col>
      </Row>
      <Row style={{ padding: "10px" }}>
          <Row className="border-bottom mb-4"><h2>Reserve our tavern for your event</h2></Row>
        <Col xs={12} lg={5} style={{ height: "400px", padding: "10px" }} className="mb-3">
