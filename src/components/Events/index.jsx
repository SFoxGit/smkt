    ...
    <Container>
      <Row style={{ padding: "10px" }}>
        ...
        <Col xs={12} lg={5} style={{ height: "400px", padding: "10px" }} className="mb-3">
          <Image style={{ height: "400px", objectFit: "cover" }} src={process.env.PUBLIC_URL + "/images/patio.jpg"} roundedCircle fluid />
        </Col>
      </Row>
      <Row style={{ padding: "10px" }}>
      <Col xs={12}><Row className="border-bottom mb-4"><h2>Reserve our tavern for your event</h2></Row></Col>
        <Col xs={12} lg={5} style={{ height: "400px", padding: "10px" }} className="mb-3">
          <Image style={{ height: "400px", objectFit: "cover" }} src={process.env.PUBLIC_URL + "/images/bar.jpg"} roundedCircle fluid />
        </Col>
        <Col xs={0} lg={2}></Col>
        <Col xs={12} lg={5} style={{ padding: "10px" }}>
